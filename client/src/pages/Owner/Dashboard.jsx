...
const fetchDashboardData = async () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex flex-col gap-6'>
      ...
      <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3xl'>
        ...
        {dashboardCards.map((card, index) => (
          <div
            key={index}
            className='flex items-center justify-between p-4 rounded-md border border-gray-200 shadow-sm bg-white'
          >
            <div>
